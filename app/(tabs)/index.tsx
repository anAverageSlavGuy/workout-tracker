...
const styles = StyleSheet.create({
  ...
  startBtnInner: { alignItems: 'center', gap: 6 },
  ...
  sheet: {
    ...
    padding: 24, gap: 6, paddingBottom: 40,
  },
  sheetHandle: { width: 36, height: 3, backgroundColor: colors.border, alignSelf: 'center', marginBottom: 12 },
  sheetTitle: { fontSize: 11, color: colors.textMuted, letterSpacing: 5, marginBottom: 8 },
  sheetOption: {
    paddingVertical: 16, paddingHorizontal: 16, marginVertical: 3,
  ...
  sheetOptionSub: { fontSize: 11, color: colors.textMuted, marginTop: 3, letterSpacing: 1 },
})
