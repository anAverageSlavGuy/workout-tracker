...
const styles = StyleSheet.create({
  ...
  searchWrap: { flexDirection: 'row', alignItems: 'center', gap: 8, margin: 16, borderWidth: 1, borderColor: colors.border, paddingHorizontal: 16, paddingVertical: 8, backgroundColor: colors.surface },
  searchIcon: { color: colors.textMuted, fontSize: 18 },
  search: { flex: 1, color: colors.text, fontSize: 14 },
  groupHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8 },
  ...
  exRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 16, borderBottomWidth: 1, borderBottomColor: colors.border, gap: 8 },
